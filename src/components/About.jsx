        ...
        <div className='bottom-gradient flex flex-col  px-28 pb-8'>
            ...
            <div className='flex flex-row'>
                <div className='w-96 text-white text-3xl text-right border-r-2 border-[#C099E4] pr-4'>
                    <h1></h1>
                    <h1>10<br/> Projects</h1><br/><br/>
                    <h1>3<br/>Awards</h1><br/><br/>
                    <h1>Many<br/>happy clients</h1>
                </div>
                <div className='flex flex-col gap-10 text-white pl-8 pr-10 '>
                    ...
                    <div className='text-xl'>
                        ...
                        <div className='flex flex-row gap-3 py-5'>
                            <a href="https://www.facebook.com/profile.php?id=100007166771427" target='_blank'><img src={facebook} alt="" /></a>
                            <a href="https://www.linkedin.com/in/prashnta-pandey-2b91211a3/" target='_blank'><img src={twitter} alt="" /></a>
                            <a href="https://twitter.com/PrashntaPandey" target='_blank'><img src={linkedin} alt="" /></a>
                        </div>
                    </div>
                </div>
            </div>
